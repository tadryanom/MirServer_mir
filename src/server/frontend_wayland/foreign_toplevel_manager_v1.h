...
class ForeignToplevelManagerV1 : public wayland::ForeignToplevelManagerV1::Global
{
public:
    ForeignToplevelManagerV1(wl_display* display, std::shared_ptr<Shell> const shell, WlSeat& seat, OutputManager* output_manager);
